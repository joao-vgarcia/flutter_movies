...
class MovieDbDatasource implements MovieDatasource {
  ...
  Future<MovieModel> getMovieById(int id) async {
    final response = await dio.get(
        'https://api.themoviedb.org/3/movie/$id?api_key=f762b12aa5ec3b09e39664a9a0915134');
  ...
  Future<List<SimilarMovie>> getSimilarMovies(int id) async {
    final response = await dio.get('https://api.themoviedb.org/3/movie/$id/similar?api_key=f762b12aa5ec3b09e39664a9a0915134');
